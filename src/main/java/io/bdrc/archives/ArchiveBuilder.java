...
public class ArchiveBuilder {
	...
	public static boolean isPdfDone(String id) {
		...
		log.debug("IS PDF DONE returns from cache value for " + id + ">>"
				+ (boolean) ServerCache.getObjectFromCache("pdfjobs", id));
	...
	public static boolean isZipDone(String id) {
		...
		log.debug("IS ZIP DONE returns from cache value for " + id + ">>"
				+ (boolean) ServerCache.getObjectFromCache("zipjobs", id));
